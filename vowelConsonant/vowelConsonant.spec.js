...
describe('Count vowel and consonant', function() {
    ...
    it('count ab', function() {
        assert.deepEqual(vowelConsonantCount('ab'), {
            v: 1,
            c: 1
        });
    });
    ...
    it('count hello', function() {
        assert.deepEqual(vowelConsonantCount('hello'), {
            v: 2,
            c: 3
        });
    });
    ...
    it('count empty', function() {
        assert.deepEqual(vowelConsonantCount(''), {
            v: 0,
            c: 0
        });
    });
    ...
    it('count number', function() {
        assert.deepEqual(vowelConsonantCount(3), {
            v: 0,
            c: 0
        });
    });
